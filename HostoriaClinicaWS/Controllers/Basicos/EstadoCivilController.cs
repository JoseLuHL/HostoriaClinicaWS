...
namespace HostoriaClinicaWS.Controllers
{
    ...
    public class EstadoCivilController : ControllerBase
    {
        ...
        public EstadoCivilController(HistoriaClinicaContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != estadoCivil.EstCivilCodigo)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<EstadoCivil>> PostEstadoCivil(EstadoCivil estadoCivil)
        {
            ...
            return CreatedAtAction("GetEstadoCivil", new { id = estadoCivil.EstCivilCodigo }, estadoCivil);
        }
        ...
        {
            return _context.EstadoCivil.Any(e => e.EstCivilCodigo == id);
        }
    }
}
